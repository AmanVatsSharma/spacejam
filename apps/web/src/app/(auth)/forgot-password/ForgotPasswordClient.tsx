/**
 * File:        apps/web/src/app/(auth)/forgot-password/ForgotPasswordClient.tsx
 * Module:      Web · Auth
 * Purpose:     Client-side forgot-password content. Always shows a success
 *              state after submit to avoid leaking which emails are registered.
 *
