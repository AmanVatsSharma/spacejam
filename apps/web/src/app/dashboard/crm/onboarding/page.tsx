                ...
                {currentStep === 3 && !showRoomBooking && (
                  <div className="flex flex-col gap-8 pb-4">
                    ...
                    <div>
                      ...
                      <button className="w-full py-4 rounded-xl border border-[#FF6A2F] bg-[#FFF8F6] hover:bg-[#FFEAE0] transition-colors flex flex-col items-center justify-center gap-1">
