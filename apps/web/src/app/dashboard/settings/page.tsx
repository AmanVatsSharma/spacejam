...
export default function SettingsAccessPage() {
  ...
  const defaultUser =
    users.length > 0
      ? (users.find((u) => u.role === 'CENTER_MANAGER') ?? users[0])
      : null;
  ...
  async function handleSuspend() {
    ...
    try {
      await setUserActiveMut({
        variables: { id: activeUser.id, active: next },
      });
  ...
  async function handleDelete() {
    ...
    if (
      !window.confirm(
        `Delete user "${activeUser.name}"? This cannot be undone.`,
      )
    )
      return;
    try {
  ...
  const renderUserGroup = (groupName: string) => {
    ...
    const usersInGroup = users.filter(
      (u) => ROLE_GROUP_MAP[u.role] === groupName,
    );
        ...
        {usersInGroup.map((user) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={`${styles.listUserStatus} ${user.active ? styles.statusTxtActive : styles.statusTxtSuspended}`}
              >
      ...
      <div className={styles.splitLayout}>
        ...
        <div className={styles.leftCol}>
          {activeTab === 'Profile' && !activeUser ? (
            ...
            <>
              ...
              <div className={styles.formGrid}>
                ...
                <div className={styles.formGroupFull}>
                  ...
                  <input
                    type="text"
                    className={styles.formInput}
                    value={activeUser!.center?.name || 'No center assigned'}
                    disabled
                  />
                </div>
              </div>
              ...
              <div>
                <div className={styles.statusRow}>
                  ...
                  <div
                    className={`${styles.toggleSwitch} ${!accountEnabled ? styles.toggleSwitchOff : ''}`}
                    onClick={() => setAccountEnabled(!accountEnabled)}
                  >
                    <div
                      className={styles.toggleKnob}
                      style={{
                        transform: accountEnabled
                          ? 'translateX(24px)'
                          : 'translateX(0px)',
            ...
            <>
              <input
                type="text"
                className={styles.permSearchBox}
              ...
              <PermGroup
                ...
                items={[
                  ...
                  ['overrideRoomLimits', 'Override room limits'],
                ]}
              />
              <PermGroup
                ...
                items={[
                  ...
                  ['freezeDeposits', 'Freeze deposits'],
                  ['accessInvoices', 'Access invoices'],
                ]}
              />
              <PermGroup
                ...
                {activeUser?.center ? (
                  <div className={styles.radioGroup}>
                    <div className={styles.radioItem}>
                      <div
                        className={`${styles.radioIcon} ${styles.radioIconActive}`}
                      >
                        <div className={styles.radioDot}></div>
                      </div>
                      <span className={styles.radioLabel}>
                        {activeUser.center.name}
                      </span>
                    </div>
                  </div>
                ) : (
              ...
              <div className={styles.secGroup}>
                ...
                <div className={styles.secRow}>
                  <div className={styles.secRowInfo}>
                    ...
                    <span className={styles.secRowSub}>
                  ...
                  >
                    <div
                      className={styles.toggleKnob}
                      style={{
                        transform: secDraft.otpRequired
                          ? 'translateX(24px)'
                          : 'translateX(0px)',
                      }}
                    ></div>
                ...
                <div className={styles.secRow}>
                  <div className={styles.secRowInfo}>
                    ...
                    <span className={styles.secRowSub}>
                      Allow fingerprint/face ID
                    </span>
                  </div>
                  <div
                    className={`${styles.toggleSwitch} ${!secDraft.biometricLogin ? styles.toggleSwitchOff : ''}`}
                    onClick={() =>
                      setSec('biometricLogin', !secDraft.biometricLogin)
                    }
                  >
                    <div
                      className={styles.toggleKnob}
                      style={{
                        transform: secDraft.biometricLogin
                          ? 'translateX(24px)'
                          : 'translateX(0px)',
                      }}
                    ></div>
                ...
                <div className={styles.secInputGroup}>
                  <span className={styles.secRowTitle}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setSec('sessionTimeout', Number(e.target.value))
                    }
                    min={5}
                    max={480}
                  />
              ...
              <div className={styles.secGroup}>
                ...
                <div className={styles.secRow}>
                  <div className={styles.secRowInfo}>
                    ...
                    <span className={styles.secRowSub}>
                      {activeUser?.phone || 'Not configured'}
                    </span>
                  </div>
                  <div
        ...
        <div className={styles.rightCol}>
          ...
          <div className={styles.listFilters}>
            ...
            <div className={styles.listFilterBtn}>
              Center {Icons.chevronDown}
            </div>
          </div>
