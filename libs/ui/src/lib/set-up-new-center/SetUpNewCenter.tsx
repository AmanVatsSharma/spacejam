...
import styles from './SetUpNewCenter.module.css';
          ...
          <div className={styles.productList}>
            ...
            {products.map((product) => (
              <div key={product.id} className={styles.productRow}>
                ...
                <span className={styles.productData}>₹{product.basePrice}</span>
                ...
                <span className={styles.productData}>
                  {product.tokenEnabled ? `₹${product.tokenValue}` : '-'}
                </span>
                <button
